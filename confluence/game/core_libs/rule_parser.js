...
xhr2.open("GET", "newdata/data/actions.txt", true);
xhr2.onreadystatechange = function() {
	if ((xhr2.status === 200)&&(xhr2.readyState==4)) 
	{
		document.getElementById("ruletext").value=xhr2.responseText;
	}
};
...
//moved init function to ensembleInit
...
function parse()
{
	...
	//}//by default schema.json is loaded from the web page's folder, and for now you can't change the schema while game is running
