...
define(["util", "underscore", "ruleLibrary_duplicate", "actionLibrary_duplicate", "sfdb_duplicate", "validate_duplicate"],// test uses jquery which can't work in webworker, and it is minified so I removed it completely
